...
*/
template < class SignatureType, class DataObjectType >
void ColorStructureExtractor<SignatureType, DataObjectType>::setNumFeatures(u_int16_t value) throw (std::runtime_error){
...
*/
template < class SignatureType, class DataObjectType >
u_int16_t ColorStructureExtractor<SignatureType, DataObjectType>:: getNumFeatures(){
...
*/
template < class SignatureType, class DataObjectType>
ColorStructureExtractor<SignatureType, DataObjectType>::ColorStructureExtractor(u_int16_t value) throw (std::runtime_error) {
