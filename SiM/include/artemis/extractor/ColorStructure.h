...
class ColorStructureExtractor : public Extractor<SignatureType, DataObjectType> {
    ...
    public:
        ColorStructureExtractor(u_int16_t value = 128) throw (std::runtime_error);
        virtual ~ColorStructureExtractor() {}

        void setNumFeatures(u_int16_t value) throw (std::runtime_error);
