...
*
*/
void JPGImage::loadPixelMatrix(IplImage *image) throw (std::runtime_error){
...
JPGImage::JPGImage(IplImage *image){
    setFilename("NO_FILE");
    if (!image)
       throw std::runtime_error("Error loading jpg image");
